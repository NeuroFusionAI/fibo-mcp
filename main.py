...
def sparql(query: str) -> str:
    ...
    > Would you like me to create a diagram? (uses diagramming-expert skill)

    If yes, create ONE focused diagram showing the key concept and its immediate relationships. Keep it simple.
